...
- Added GetTss command

### Fixed

- FlexBy: Fixed scoreboard ordering for Sonic 4 Ep1&2 and Sonic CD
- rjuniorfl-afk: Fixed is_slot_private
...
- FlexBy: Added DeleteTrophies command
...
- FlexBy: Added trophy sync commands
...
- Added a file cleaner task to queue files to be cleaned after a certain time
...
- Added an optional --cert-gen CLI parameter to generate a certificate
...
- Added support for GetRoomMemberDataExternalList request

### Fixed

- Prevents users from setting SCE_NP_MATCHING2_ROOM_FLAG_ATTR_FULL flag
...
- Fixed a possible stack overflow on server termination
...
- Added SignalingOptParam information to replies of users creating/joining a Matching2 room

### Fixed

- FlexBy: Fixed scoreboards ordering for Resident Evil 4 and Resident Evil: Code Veronica X
