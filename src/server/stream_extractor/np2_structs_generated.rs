...
impl<'a> BinAttr<'a> {
	...
	#[allow(unused_mut)]
	pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(_fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>, args: &'args BinAttrArgs<'args>) -> flatbuffers::WIPOffset<BinAttr<'bldr>> {
	...
	pub fn data(&self) -> Option<&'a [u8]> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(BinAttr::VT_DATA, None)
			.map(|v| v.safe_slice())
	}
}
...
impl<'a: 'b, 'b> BinAttrBuilder<'a, 'b> {
	...
	pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> BinAttrBuilder<'a, 'b> {
		...
		BinAttrBuilder { fbb_: _fbb, start_: start }
	}
	#[inline]
...
impl<'a> IntAttr<'a> {
	...
	#[allow(unused_mut)]
	pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(_fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>, args: &'args IntAttrArgs) -> flatbuffers::WIPOffset<IntAttr<'bldr>> {
...
impl<'a: 'b, 'b> IntAttrBuilder<'a, 'b> {
	...
	pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> IntAttrBuilder<'a, 'b> {
		let start = _fbb.start_table();
		IntAttrBuilder { fbb_: _fbb, start_: start }
	}
	#[inline]
...
impl<'a> Default for RoomMemberBinAttrInternalArgs<'a> {
	#[inline]
	fn default() -> Self {
		RoomMemberBinAttrInternalArgs { updateDate: 0, data: None }
	}
}
...
impl<'a: 'b, 'b> RoomMemberBinAttrInternalBuilder<'a, 'b> {
	...
	pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> RoomMemberBinAttrInternalBuilder<'a, 'b> {
		let start = _fbb.start_table();
		RoomMemberBinAttrInternalBuilder { fbb_: _fbb, start_: start }
	}
	#[inline]
...
impl<'a: 'b, 'b> BinAttrInternalBuilder<'a, 'b> {
	...
	pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> BinAttrInternalBuilder<'a, 'b> {
		let start = _fbb.start_table();
		BinAttrInternalBuilder { fbb_: _fbb, start_: start }
	}
	#[inline]
...
impl<'a> OptParam<'a> {
	...
	#[allow(unused_mut)]
	pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(_fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>, args: &'args OptParamArgs) -> flatbuffers::WIPOffset<OptParam<'bldr>> {
...
impl<'a> Default for OptParamArgs {
	#[inline]
	fn default() -> Self {
		OptParamArgs { type_: 0, flag: 0, hubMemberId: 0 }
	}
}
...
impl<'a: 'b, 'b> OptParamBuilder<'a, 'b> {
	...
	pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> OptParamBuilder<'a, 'b> {
		let start = _fbb.start_table();
		OptParamBuilder { fbb_: _fbb, start_: start }
	}
	#[inline]
...
impl<'a> GroupConfig<'a> {
	...
	pub fn label(&self) -> Option<&'a [u8]> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(GroupConfig::VT_LABEL, None)
			.map(|v| v.safe_slice())
	}
	#[inline]
...
impl<'a: 'b, 'b> GroupConfigBuilder<'a, 'b> {
	...
	pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> GroupConfigBuilder<'a, 'b> {
		let start = _fbb.start_table();
		GroupConfigBuilder { fbb_: _fbb, start_: start }
	}
	#[inline]
...
impl<'a> UserInfo2<'a> {
	...
	pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
		...
		if let Some(x) = args.avatarUrl {
			builder.add_avatarUrl(x);
		}
		if let Some(x) = args.onlineName {
			builder.add_onlineName(x);
		}
		if let Some(x) = args.npId {
			builder.add_npId(x);
		}
		builder.finish()
	}
...
impl<'a: 'b, 'b> UserInfo2Builder<'a, 'b> {
	...
	pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> UserInfo2Builder<'a, 'b> {
		let start = _fbb.start_table();
		UserInfo2Builder { fbb_: _fbb, start_: start }
	}
	#[inline]
...
impl<'a> RoomMemberDataInternal<'a> {
	...
	pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
		...
		if let Some(x) = args.roomMemberBinAttrInternal {
			builder.add_roomMemberBinAttrInternal(x);
		}
		builder.add_flagAttr(args.flagAttr);
		if let Some(x) = args.userInfo {
			builder.add_userInfo(x);
		}
	...
	pub fn roomMemberBinAttrInternal(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<RoomMemberBinAttrInternal<'a>>>> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<RoomMemberBinAttrInternal>>>>(RoomMemberDataInternal::VT_ROOMMEMBERBINATTRINTERNAL, None)
	}
}
...
impl flatbuffers::Verifiable for RoomMemberDataInternal<'_> {
	...
	fn run_verifier(v: &mut flatbuffers::Verifier, pos: usize) -> Result<(), flatbuffers::InvalidFlatbuffer> {
		...
		v.visit_table(pos)?
			...
			.visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<RoomMemberBinAttrInternal>>>>(
				&"roomMemberBinAttrInternal",
				Self::VT_ROOMMEMBERBINATTRINTERNAL,
				false,
			)?
			.finish();
		Ok(())
...
impl<'a: 'b, 'b> RoomMemberDataInternalBuilder<'a, 'b> {
	...
	pub fn add_roomMemberBinAttrInternal(&mut self, roomMemberBinAttrInternal: flatbuffers::WIPOffset<flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<RoomMemberBinAttrInternal<'b>>>>) {
		self.fbb_
			.push_slot_always::<flatbuffers::WIPOffset<_>>(RoomMemberDataInternal::VT_ROOMMEMBERBINATTRINTERNAL, roomMemberBinAttrInternal);
	}
	#[inline]
	pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> RoomMemberDataInternalBuilder<'a, 'b> {
		let start = _fbb.start_table();
		RoomMemberDataInternalBuilder { fbb_: _fbb, start_: start }
	}
	#[inline]
...
impl<'a> RoomGroup<'a> {
	...
	pub fn label(&self) -> Option<&'a [u8]> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(RoomGroup::VT_LABEL, None)
			.map(|v| v.safe_slice())
	}
	#[inline]
	pub fn slotNum(&self) -> u32 {
...
impl<'a: 'b, 'b> RoomGroupBuilder<'a, 'b> {
	...
	pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> RoomGroupBuilder<'a, 'b> {
		let start = _fbb.start_table();
		RoomGroupBuilder { fbb_: _fbb, start_: start }
	}
	#[inline]
...
impl<'a> RoomDataInternal<'a> {
	...
	pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
		...
		if let Some(x) = args.roomBinAttrInternal {
			builder.add_roomBinAttrInternal(x);
		}
		builder.add_flagAttr(args.flagAttr);
		if let Some(x) = args.roomGroup {
			builder.add_roomGroup(x);
		}
		if let Some(x) = args.memberList {
			builder.add_memberList(x);
		}
	...
	pub fn memberList(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<RoomMemberDataInternal<'a>>>> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<RoomMemberDataInternal>>>>(RoomDataInternal::VT_MEMBERLIST, None)
	}
	#[inline]
	...
	pub fn roomGroup(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<RoomGroup<'a>>>> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<RoomGroup>>>>(RoomDataInternal::VT_ROOMGROUP, None)
	}
	#[inline]
	pub fn flagAttr(&self) -> u32 {
	...
	pub fn roomBinAttrInternal(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BinAttrInternal<'a>>>> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BinAttrInternal>>>>(RoomDataInternal::VT_ROOMBINATTRINTERNAL, None)
	}
}
...
impl<'a: 'b, 'b> RoomDataInternalBuilder<'a, 'b> {
	...
	pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> RoomDataInternalBuilder<'a, 'b> {
		let start = _fbb.start_table();
		RoomDataInternalBuilder { fbb_: _fbb, start_: start }
	}
	#[inline]
...
impl<'a> RoomDataExternal<'a> {
	...
	pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
		...
		builder.add_roomId(args.roomId);
		builder.add_lobbyId(args.lobbyId);
		if let Some(x) = args.roomBinAttrExternal {
			builder.add_roomBinAttrExternal(x);
		}
		if let Some(x) = args.roomSearchableBinAttrExternal {
			builder.add_roomSearchableBinAttrExternal(x);
		}
		if let Some(x) = args.roomSearchableIntAttrExternal {
			builder.add_roomSearchableIntAttrExternal(x);
		}
		builder.add_flagAttr(args.flagAttr);
		if let Some(x) = args.roomGroup {
			builder.add_roomGroup(x);
	...
	pub fn roomGroup(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<RoomGroup<'a>>>> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<RoomGroup>>>>(RoomDataExternal::VT_ROOMGROUP, None)
	}
	#[inline]
	pub fn flagAttr(&self) -> u32 {
	...
	pub fn roomSearchableIntAttrExternal(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<IntAttr<'a>>>> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<IntAttr>>>>(RoomDataExternal::VT_ROOMSEARCHABLEINTATTREXTERNAL, None)
	}
	#[inline]
	pub fn roomSearchableBinAttrExternal(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BinAttr<'a>>>> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BinAttr>>>>(RoomDataExternal::VT_ROOMSEARCHABLEBINATTREXTERNAL, None)
	}
	#[inline]
	pub fn roomBinAttrExternal(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BinAttr<'a>>>> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BinAttr>>>>(RoomDataExternal::VT_ROOMBINATTREXTERNAL, None)
	}
}
...
impl flatbuffers::Verifiable for RoomDataExternal<'_> {
	...
	fn run_verifier(v: &mut flatbuffers::Verifier, pos: usize) -> Result<(), flatbuffers::InvalidFlatbuffer> {
		...
		v.visit_table(pos)?
			...
			.visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<RoomGroup>>>>(&"roomGroup", Self::VT_ROOMGROUP, false)?
			.visit_field::<u32>(&"flagAttr", Self::VT_FLAGATTR, false)?
			.visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<IntAttr>>>>(
				&"roomSearchableIntAttrExternal",
				Self::VT_ROOMSEARCHABLEINTATTREXTERNAL,
				false,
			)?
			.visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<BinAttr>>>>(
				&"roomSearchableBinAttrExternal",
				Self::VT_ROOMSEARCHABLEBINATTREXTERNAL,
				false,
			)?
...
impl<'a: 'b, 'b> RoomDataExternalBuilder<'a, 'b> {
	...
	pub fn add_roomSearchableIntAttrExternal(&mut self, roomSearchableIntAttrExternal: flatbuffers::WIPOffset<flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<IntAttr<'b>>>>) {
		self.fbb_
			.push_slot_always::<flatbuffers::WIPOffset<_>>(RoomDataExternal::VT_ROOMSEARCHABLEINTATTREXTERNAL, roomSearchableIntAttrExternal);
	}
	#[inline]
	pub fn add_roomSearchableBinAttrExternal(&mut self, roomSearchableBinAttrExternal: flatbuffers::WIPOffset<flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<BinAttr<'b>>>>) {
		self.fbb_
			.push_slot_always::<flatbuffers::WIPOffset<_>>(RoomDataExternal::VT_ROOMSEARCHABLEBINATTREXTERNAL, roomSearchableBinAttrExternal);
	}
	#[inline]
	...
	pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> RoomDataExternalBuilder<'a, 'b> {
		let start = _fbb.start_table();
		RoomDataExternalBuilder { fbb_: _fbb, start_: start }
	}
	#[inline]
...
impl<'a> Default for IntSearchFilterArgs<'a> {
	#[inline]
	fn default() -> Self {
		IntSearchFilterArgs { searchOperator: 0, attr: None }
	}
}
...
impl<'a: 'b, 'b> IntSearchFilterBuilder<'a, 'b> {
	...
	pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> IntSearchFilterBuilder<'a, 'b> {
		let start = _fbb.start_table();
		IntSearchFilterBuilder { fbb_: _fbb, start_: start }
	}
	#[inline]
...
impl<'a> Default for BinSearchFilterArgs<'a> {
	#[inline]
	fn default() -> Self {
		BinSearchFilterArgs { searchOperator: 0, attr: None }
	}
}
...
impl<'a: 'b, 'b> BinSearchFilterBuilder<'a, 'b> {
	...
	pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> BinSearchFilterBuilder<'a, 'b> {
		let start = _fbb.start_table();
		BinSearchFilterBuilder { fbb_: _fbb, start_: start }
	}
	#[inline]
...
impl<'a> PresenceOptionData<'a> {
	...
	pub fn data(&self) -> Option<&'a [u8]> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(PresenceOptionData::VT_DATA, None)
			.map(|v| v.safe_slice())
	}
	#[inline]
	pub fn len(&self) -> u32 {
...
impl<'a> Default for PresenceOptionDataArgs<'a> {
	#[inline]
	fn default() -> Self {
		PresenceOptionDataArgs { data: None, len: 0 }
	}
}
...
impl<'a: 'b, 'b> PresenceOptionDataBuilder<'a, 'b> {
	...
	pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> PresenceOptionDataBuilder<'a, 'b> {
		let start = _fbb.start_table();
		PresenceOptionDataBuilder { fbb_: _fbb, start_: start }
	}
	#[inline]
...
impl<'a> RoomGroupPasswordConfig<'a> {
	...
	pub fn groupId(&self) -> Option<&'a [u8]> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(RoomGroupPasswordConfig::VT_GROUPID, None)
			.map(|v| v.safe_slice())
	}
	#[inline]
	pub fn withPassword(&self) -> bool {
...
impl<'a> Default for RoomGroupPasswordConfigArgs<'a> {
	#[inline]
	fn default() -> Self {
		RoomGroupPasswordConfigArgs { groupId: None, withPassword: false }
	}
}
...
impl<'a: 'b, 'b> RoomGroupPasswordConfigBuilder<'a, 'b> {
	...
	pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> RoomGroupPasswordConfigBuilder<'a, 'b> {
		let start = _fbb.start_table();
		RoomGroupPasswordConfigBuilder { fbb_: _fbb, start_: start }
	}
	#[inline]
...
impl<'a> SearchRoomRequest<'a> {
	...
	pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
		...
		builder.add_lobbyId(args.lobbyId);
		if let Some(x) = args.attrId {
			builder.add_attrId(x);
		}
		if let Some(x) = args.binFilter {
			builder.add_binFilter(x);
		}
		if let Some(x) = args.intFilter {
			builder.add_intFilter(x);
		}
		builder.add_flagAttr(args.flagAttr);
	...
	pub fn intFilter(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<IntSearchFilter<'a>>>> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<IntSearchFilter>>>>(SearchRoomRequest::VT_INTFILTER, None)
	}
	#[inline]
	pub fn binFilter(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BinSearchFilter<'a>>>> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BinSearchFilter>>>>(SearchRoomRequest::VT_BINFILTER, None)
	}
	#[inline]
...
impl<'a: 'b, 'b> SearchRoomRequestBuilder<'a, 'b> {
	...
	pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> SearchRoomRequestBuilder<'a, 'b> {
		let start = _fbb.start_table();
		SearchRoomRequestBuilder { fbb_: _fbb, start_: start }
	}
	#[inline]
...
impl<'a> SearchRoomResponse<'a> {
	...
	pub fn rooms(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<RoomDataExternal<'a>>>> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<RoomDataExternal>>>>(SearchRoomResponse::VT_ROOMS, None)
	}
}
...
impl<'a: 'b, 'b> SearchRoomResponseBuilder<'a, 'b> {
	...
	pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> SearchRoomResponseBuilder<'a, 'b> {
		let start = _fbb.start_table();
		SearchRoomResponseBuilder { fbb_: _fbb, start_: start }
	}
	#[inline]
...
impl<'a> CreateJoinRoomRequest<'a> {
	...
	pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
		...
		builder.add_passwordSlotMask(args.passwordSlotMask);
		builder.add_lobbyId(args.lobbyId);
		if let Some(x) = args.sigOptParam {
			builder.add_sigOptParam(x);
		}
		if let Some(x) = args.roomMemberBinAttrInternal {
			builder.add_roomMemberBinAttrInternal(x);
		}
		if let Some(x) = args.joinRoomGroupLabel {
			builder.add_joinRoomGroupLabel(x);
		}
		if let Some(x) = args.blockedUser {
			builder.add_blockedUser(x);
		}
		if let Some(x) = args.allowedUser {
			builder.add_allowedUser(x);
		}
		if let Some(x) = args.groupConfig {
			builder.add_groupConfig(x);
		}
		if let Some(x) = args.roomPassword {
			builder.add_roomPassword(x);
		}
		if let Some(x) = args.roomBinAttrExternal {
			builder.add_roomBinAttrExternal(x);
		}
	...
	pub fn roomBinAttrInternal(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BinAttr<'a>>>> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BinAttr>>>>(CreateJoinRoomRequest::VT_ROOMBINATTRINTERNAL, None)
	}
	#[inline]
	pub fn roomSearchableIntAttrExternal(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<IntAttr<'a>>>> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<IntAttr>>>>(CreateJoinRoomRequest::VT_ROOMSEARCHABLEINTATTREXTERNAL, None)
	}
	#[inline]
	pub fn roomSearchableBinAttrExternal(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BinAttr<'a>>>> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BinAttr>>>>(CreateJoinRoomRequest::VT_ROOMSEARCHABLEBINATTREXTERNAL, None)
	}
	#[inline]
	pub fn roomBinAttrExternal(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BinAttr<'a>>>> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BinAttr>>>>(CreateJoinRoomRequest::VT_ROOMBINATTREXTERNAL, None)
	}
	#[inline]
	pub fn roomPassword(&self) -> Option<&'a [u8]> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(CreateJoinRoomRequest::VT_ROOMPASSWORD, None)
			.map(|v| v.safe_slice())
	}
	#[inline]
	pub fn groupConfig(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<GroupConfig<'a>>>> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<GroupConfig>>>>(CreateJoinRoomRequest::VT_GROUPCONFIG, None)
	}
	#[inline]
	pub fn passwordSlotMask(&self) -> u64 {
	...
	pub fn allowedUser(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(CreateJoinRoomRequest::VT_ALLOWEDUSER, None)
	}
	#[inline]
	pub fn blockedUser(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(CreateJoinRoomRequest::VT_BLOCKEDUSER, None)
	}
	#[inline]
	pub fn joinRoomGroupLabel(&self) -> Option<&'a [u8]> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(CreateJoinRoomRequest::VT_JOINROOMGROUPLABEL, None)
			.map(|v| v.safe_slice())
	}
	#[inline]
	pub fn roomMemberBinAttrInternal(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BinAttr<'a>>>> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BinAttr>>>>(CreateJoinRoomRequest::VT_ROOMMEMBERBINATTRINTERNAL, None)
	}
	#[inline]
	pub fn teamId(&self) -> u8 {
...
impl<'a: 'b, 'b> CreateJoinRoomRequestBuilder<'a, 'b> {
	...
	pub fn add_roomBinAttrInternal(&mut self, roomBinAttrInternal: flatbuffers::WIPOffset<flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<BinAttr<'b>>>>) {
		self.fbb_
			.push_slot_always::<flatbuffers::WIPOffset<_>>(CreateJoinRoomRequest::VT_ROOMBINATTRINTERNAL, roomBinAttrInternal);
	}
	#[inline]
	pub fn add_roomSearchableIntAttrExternal(&mut self, roomSearchableIntAttrExternal: flatbuffers::WIPOffset<flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<IntAttr<'b>>>>) {
		self.fbb_
			.push_slot_always::<flatbuffers::WIPOffset<_>>(CreateJoinRoomRequest::VT_ROOMSEARCHABLEINTATTREXTERNAL, roomSearchableIntAttrExternal);
	}
	#[inline]
	pub fn add_roomSearchableBinAttrExternal(&mut self, roomSearchableBinAttrExternal: flatbuffers::WIPOffset<flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<BinAttr<'b>>>>) {
		self.fbb_
			.push_slot_always::<flatbuffers::WIPOffset<_>>(CreateJoinRoomRequest::VT_ROOMSEARCHABLEBINATTREXTERNAL, roomSearchableBinAttrExternal);
	}
	#[inline]
	pub fn add_roomBinAttrExternal(&mut self, roomBinAttrExternal: flatbuffers::WIPOffset<flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<BinAttr<'b>>>>) {
		self.fbb_
			.push_slot_always::<flatbuffers::WIPOffset<_>>(CreateJoinRoomRequest::VT_ROOMBINATTREXTERNAL, roomBinAttrExternal);
	}
	#[inline]
	...
	pub fn add_joinRoomGroupLabel(&mut self, joinRoomGroupLabel: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u8>>) {
		self.fbb_
			.push_slot_always::<flatbuffers::WIPOffset<_>>(CreateJoinRoomRequest::VT_JOINROOMGROUPLABEL, joinRoomGroupLabel);
	}
	#[inline]
	pub fn add_roomMemberBinAttrInternal(&mut self, roomMemberBinAttrInternal: flatbuffers::WIPOffset<flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<BinAttr<'b>>>>) {
		self.fbb_
			.push_slot_always::<flatbuffers::WIPOffset<_>>(CreateJoinRoomRequest::VT_ROOMMEMBERBINATTRINTERNAL, roomMemberBinAttrInternal);
	}
	#[inline]
	pub fn add_teamId(&mut self, teamId: u8) {
	...
	pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> CreateJoinRoomRequestBuilder<'a, 'b> {
		let start = _fbb.start_table();
		CreateJoinRoomRequestBuilder { fbb_: _fbb, start_: start }
	}
	#[inline]
...
impl<'a> JoinRoomRequest<'a> {
	...
	pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
		...
		builder.add_roomId(args.roomId);
		if let Some(x) = args.optData {
			builder.add_optData(x);
		}
		if let Some(x) = args.roomMemberBinAttrInternal {
			builder.add_roomMemberBinAttrInternal(x);
		}
	...
	pub fn roomPassword(&self) -> Option<&'a [u8]> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(JoinRoomRequest::VT_ROOMPASSWORD, None)
			.map(|v| v.safe_slice())
	}
	#[inline]
	pub fn joinRoomGroupLabel(&self) -> Option<&'a [u8]> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(JoinRoomRequest::VT_JOINROOMGROUPLABEL, None)
			.map(|v| v.safe_slice())
	}
	#[inline]
	pub fn roomMemberBinAttrInternal(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BinAttr<'a>>>> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BinAttr>>>>(JoinRoomRequest::VT_ROOMMEMBERBINATTRINTERNAL, None)
	}
	#[inline]
...
impl<'a: 'b, 'b> JoinRoomRequestBuilder<'a, 'b> {
	...
	pub fn add_roomMemberBinAttrInternal(&mut self, roomMemberBinAttrInternal: flatbuffers::WIPOffset<flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<BinAttr<'b>>>>) {
		self.fbb_
			.push_slot_always::<flatbuffers::WIPOffset<_>>(JoinRoomRequest::VT_ROOMMEMBERBINATTRINTERNAL, roomMemberBinAttrInternal);
	}
	#[inline]
	...
	pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> JoinRoomRequestBuilder<'a, 'b> {
		let start = _fbb.start_table();
		JoinRoomRequestBuilder { fbb_: _fbb, start_: start }
	}
	#[inline]
...
impl<'a> Default for LeaveRoomRequestArgs<'a> {
	#[inline]
	fn default() -> Self {
		LeaveRoomRequestArgs { roomId: 0, optData: None }
	}
}
...
impl<'a: 'b, 'b> LeaveRoomRequestBuilder<'a, 'b> {
	...
	pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> LeaveRoomRequestBuilder<'a, 'b> {
		let start = _fbb.start_table();
		LeaveRoomRequestBuilder { fbb_: _fbb, start_: start }
	}
	#[inline]
...
impl<'a> GetRoomDataExternalListRequest<'a> {
	...
	pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
		...
		if let Some(x) = args.attrIds {
			builder.add_attrIds(x);
		}
		if let Some(x) = args.roomIds {
			builder.add_roomIds(x);
		}
		builder.finish()
	}
	...
	pub fn roomIds(&self) -> Option<flatbuffers::Vector<'a, u64>> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u64>>>(GetRoomDataExternalListRequest::VT_ROOMIDS, None)
	}
	#[inline]
	pub fn attrIds(&self) -> Option<flatbuffers::Vector<'a, u16>> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u16>>>(GetRoomDataExternalListRequest::VT_ATTRIDS, None)
	}
}
...
impl<'a> Default for GetRoomDataExternalListRequestArgs<'a> {
	#[inline]
	fn default() -> Self {
		GetRoomDataExternalListRequestArgs { roomIds: None, attrIds: None }
	}
}
...
impl<'a: 'b, 'b> GetRoomDataExternalListRequestBuilder<'a, 'b> {
	...
	pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> GetRoomDataExternalListRequestBuilder<'a, 'b> {
		let start = _fbb.start_table();
		GetRoomDataExternalListRequestBuilder { fbb_: _fbb, start_: start }
	}
	#[inline]
...
impl<'a> GetRoomDataExternalListResponse<'a> {
	...
	pub fn rooms(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<RoomDataExternal<'a>>>> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<RoomDataExternal>>>>(GetRoomDataExternalListResponse::VT_ROOMS, None)
	}
}
...
impl<'a> Default for GetRoomDataExternalListResponseArgs<'a> {
	#[inline]
	fn default() -> Self {
		GetRoomDataExternalListResponseArgs { rooms: None }
	}
}
...
impl<'a: 'b, 'b> GetRoomDataExternalListResponseBuilder<'a, 'b> {
	...
	pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> GetRoomDataExternalListResponseBuilder<'a, 'b> {
		let start = _fbb.start_table();
		GetRoomDataExternalListResponseBuilder { fbb_: _fbb, start_: start }
	}
	#[inline]
...
impl<'a> SetRoomDataExternalRequest<'a> {
	...
	pub fn roomSearchableIntAttrExternal(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<IntAttr<'a>>>> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<IntAttr>>>>(SetRoomDataExternalRequest::VT_ROOMSEARCHABLEINTATTREXTERNAL, None)
	}
	#[inline]
	pub fn roomSearchableBinAttrExternal(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BinAttr<'a>>>> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BinAttr>>>>(SetRoomDataExternalRequest::VT_ROOMSEARCHABLEBINATTREXTERNAL, None)
	}
	#[inline]
	pub fn roomBinAttrExternal(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BinAttr<'a>>>> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BinAttr>>>>(SetRoomDataExternalRequest::VT_ROOMBINATTREXTERNAL, None)
	}
}
...
impl<'a: 'b, 'b> SetRoomDataExternalRequestBuilder<'a, 'b> {
	...
	pub fn add_roomSearchableIntAttrExternal(&mut self, roomSearchableIntAttrExternal: flatbuffers::WIPOffset<flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<IntAttr<'b>>>>) {
		self.fbb_
			.push_slot_always::<flatbuffers::WIPOffset<_>>(SetRoomDataExternalRequest::VT_ROOMSEARCHABLEINTATTREXTERNAL, roomSearchableIntAttrExternal);
	}
	#[inline]
	pub fn add_roomSearchableBinAttrExternal(&mut self, roomSearchableBinAttrExternal: flatbuffers::WIPOffset<flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<BinAttr<'b>>>>) {
		self.fbb_
			.push_slot_always::<flatbuffers::WIPOffset<_>>(SetRoomDataExternalRequest::VT_ROOMSEARCHABLEBINATTREXTERNAL, roomSearchableBinAttrExternal);
	}
	#[inline]
	pub fn add_roomBinAttrExternal(&mut self, roomBinAttrExternal: flatbuffers::WIPOffset<flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<BinAttr<'b>>>>) {
		self.fbb_
			.push_slot_always::<flatbuffers::WIPOffset<_>>(SetRoomDataExternalRequest::VT_ROOMBINATTREXTERNAL, roomBinAttrExternal);
	}
	#[inline]
	pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> SetRoomDataExternalRequestBuilder<'a, 'b> {
		let start = _fbb.start_table();
		SetRoomDataExternalRequestBuilder { fbb_: _fbb, start_: start }
	}
	#[inline]
...
impl<'a> SetRoomDataInternalRequest<'a> {
	...
	pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
		...
		builder.add_passwordSlotMask(args.passwordSlotMask);
		builder.add_roomId(args.roomId);
		if let Some(x) = args.ownerPrivilegeRank {
			builder.add_ownerPrivilegeRank(x);
		}
		if let Some(x) = args.passwordConfig {
			builder.add_passwordConfig(x);
		}
		if let Some(x) = args.roomBinAttrInternal {
			builder.add_roomBinAttrInternal(x);
		}
	...
	pub fn roomBinAttrInternal(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BinAttr<'a>>>> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BinAttr>>>>(SetRoomDataInternalRequest::VT_ROOMBINATTRINTERNAL, None)
	}
	#[inline]
	pub fn passwordConfig(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<RoomGroupPasswordConfig<'a>>>> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<RoomGroupPasswordConfig>>>>(SetRoomDataInternalRequest::VT_PASSWORDCONFIG, None)
	}
	#[inline]
	pub fn passwordSlotMask(&self) -> u64 {
	...
	pub fn ownerPrivilegeRank(&self) -> Option<flatbuffers::Vector<'a, u16>> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u16>>>(SetRoomDataInternalRequest::VT_OWNERPRIVILEGERANK, None)
	}
}
...
impl<'a: 'b, 'b> SetRoomDataInternalRequestBuilder<'a, 'b> {
	...
	pub fn add_roomBinAttrInternal(&mut self, roomBinAttrInternal: flatbuffers::WIPOffset<flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<BinAttr<'b>>>>) {
		self.fbb_
			.push_slot_always::<flatbuffers::WIPOffset<_>>(SetRoomDataInternalRequest::VT_ROOMBINATTRINTERNAL, roomBinAttrInternal);
	}
	#[inline]
	...
	pub fn add_ownerPrivilegeRank(&mut self, ownerPrivilegeRank: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u16>>) {
		self.fbb_
			.push_slot_always::<flatbuffers::WIPOffset<_>>(SetRoomDataInternalRequest::VT_OWNERPRIVILEGERANK, ownerPrivilegeRank);
	}
	#[inline]
	pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> SetRoomDataInternalRequestBuilder<'a, 'b> {
		let start = _fbb.start_table();
		SetRoomDataInternalRequestBuilder { fbb_: _fbb, start_: start }
	}
	#[inline]
...
impl<'a> SetRoomMemberDataInternalRequest<'a> {
	...
	pub fn roomMemberBinAttrInternal(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BinAttr<'a>>>> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BinAttr>>>>(SetRoomMemberDataInternalRequest::VT_ROOMMEMBERBINATTRINTERNAL, None)
	}
}
...
impl<'a: 'b, 'b> SetRoomMemberDataInternalRequestBuilder<'a, 'b> {
	...
	pub fn add_roomMemberBinAttrInternal(&mut self, roomMemberBinAttrInternal: flatbuffers::WIPOffset<flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<BinAttr<'b>>>>) {
		self.fbb_
			.push_slot_always::<flatbuffers::WIPOffset<_>>(SetRoomMemberDataInternalRequest::VT_ROOMMEMBERBINATTRINTERNAL, roomMemberBinAttrInternal);
	}
	#[inline]
	pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> SetRoomMemberDataInternalRequestBuilder<'a, 'b> {
		let start = _fbb.start_table();
		SetRoomMemberDataInternalRequestBuilder { fbb_: _fbb, start_: start }
	}
	#[inline]
...
impl<'a> Default for GetRoomDataInternalRequestArgs<'a> {
	#[inline]
	fn default() -> Self {
		GetRoomDataInternalRequestArgs { roomId: 0, attrId: None }
	}
}
...
impl<'a: 'b, 'b> GetRoomDataInternalRequestBuilder<'a, 'b> {
	...
	pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> GetRoomDataInternalRequestBuilder<'a, 'b> {
		let start = _fbb.start_table();
		GetRoomDataInternalRequestBuilder { fbb_: _fbb, start_: start }
	}
	#[inline]
...
impl<'a> RoomMemberUpdateInfo<'a> {
	...
	pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
		...
		if let Some(x) = args.roomMemberDataInternal {
			builder.add_roomMemberDataInternal(x);
		}
	...
	pub fn roomMemberDataInternal(&self) -> Option<RoomMemberDataInternal<'a>> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<RoomMemberDataInternal>>(RoomMemberUpdateInfo::VT_ROOMMEMBERDATAINTERNAL, None)
	}
	#[inline]
...
impl<'a: 'b, 'b> RoomMemberUpdateInfoBuilder<'a, 'b> {
	...
	pub fn add_roomMemberDataInternal(&mut self, roomMemberDataInternal: flatbuffers::WIPOffset<RoomMemberDataInternal<'b>>) {
		self.fbb_
			.push_slot_always::<flatbuffers::WIPOffset<RoomMemberDataInternal>>(RoomMemberUpdateInfo::VT_ROOMMEMBERDATAINTERNAL, roomMemberDataInternal);
	}
	#[inline]
	...
	pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> RoomMemberUpdateInfoBuilder<'a, 'b> {
		let start = _fbb.start_table();
		RoomMemberUpdateInfoBuilder { fbb_: _fbb, start_: start }
	}
	#[inline]
...
impl<'a: 'b, 'b> RoomUpdateInfoBuilder<'a, 'b> {
	...
	pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> RoomUpdateInfoBuilder<'a, 'b> {
		let start = _fbb.start_table();
		RoomUpdateInfoBuilder { fbb_: _fbb, start_: start }
	}
	#[inline]
...
impl<'a> RoomDataInternalUpdateInfo<'a> {
	...
	pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
		...
		if let Some(x) = args.newRoomBinAttrInternal {
			builder.add_newRoomBinAttrInternal(x);
		}
		if let Some(x) = args.newRoomGroup {
			builder.add_newRoomGroup(x);
		}
		builder.add_prevFlagAttr(args.prevFlagAttr);
		if let Some(x) = args.newRoomDataInternal {
			builder.add_newRoomDataInternal(x);
		}
		builder.finish()
	}
	...
	pub fn newRoomDataInternal(&self) -> Option<RoomDataInternal<'a>> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<RoomDataInternal>>(RoomDataInternalUpdateInfo::VT_NEWROOMDATAINTERNAL, None)
	}
	#[inline]
	...
	pub fn newRoomGroup(&self) -> Option<&'a [u8]> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(RoomDataInternalUpdateInfo::VT_NEWROOMGROUP, None)
			.map(|v| v.safe_slice())
	}
	#[inline]
	pub fn newRoomBinAttrInternal(&self) -> Option<flatbuffers::Vector<'a, u16>> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u16>>>(RoomDataInternalUpdateInfo::VT_NEWROOMBINATTRINTERNAL, None)
	}
}
...
impl<'a: 'b, 'b> RoomDataInternalUpdateInfoBuilder<'a, 'b> {
	...
	pub fn add_newRoomDataInternal(&mut self, newRoomDataInternal: flatbuffers::WIPOffset<RoomDataInternal<'b>>) {
		self.fbb_
			.push_slot_always::<flatbuffers::WIPOffset<RoomDataInternal>>(RoomDataInternalUpdateInfo::VT_NEWROOMDATAINTERNAL, newRoomDataInternal);
	}
	#[inline]
	...
	pub fn add_newRoomBinAttrInternal(&mut self, newRoomBinAttrInternal: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u16>>) {
		self.fbb_
			.push_slot_always::<flatbuffers::WIPOffset<_>>(RoomDataInternalUpdateInfo::VT_NEWROOMBINATTRINTERNAL, newRoomBinAttrInternal);
	}
	#[inline]
	pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> RoomDataInternalUpdateInfoBuilder<'a, 'b> {
		let start = _fbb.start_table();
		RoomDataInternalUpdateInfoBuilder { fbb_: _fbb, start_: start }
	}
	#[inline]
...
impl<'a> RoomMemberDataInternalUpdateInfo<'a> {
	...
	pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
		...
		if let Some(x) = args.newRoomMemberBinAttrInternal {
			builder.add_newRoomMemberBinAttrInternal(x);
		}
		builder.add_prevFlagAttr(args.prevFlagAttr);
		if let Some(x) = args.newRoomMemberDataInternal {
			builder.add_newRoomMemberDataInternal(x);
		}
	...
	pub fn newRoomMemberDataInternal(&self) -> Option<RoomMemberDataInternal<'a>> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<RoomMemberDataInternal>>(RoomMemberDataInternalUpdateInfo::VT_NEWROOMMEMBERDATAINTERNAL, None)
	}
	#[inline]
	pub fn prevFlagAttr(&self) -> u32 {
	...
	pub fn newRoomMemberBinAttrInternal(&self) -> Option<flatbuffers::Vector<'a, u16>> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u16>>>(RoomMemberDataInternalUpdateInfo::VT_NEWROOMMEMBERBINATTRINTERNAL, None)
	}
}
...
impl<'a: 'b, 'b> RoomMemberDataInternalUpdateInfoBuilder<'a, 'b> {
	...
	pub fn add_newRoomMemberDataInternal(&mut self, newRoomMemberDataInternal: flatbuffers::WIPOffset<RoomMemberDataInternal<'b>>) {
		self.fbb_
			.push_slot_always::<flatbuffers::WIPOffset<RoomMemberDataInternal>>(RoomMemberDataInternalUpdateInfo::VT_NEWROOMMEMBERDATAINTERNAL, newRoomMemberDataInternal);
	}
	#[inline]
	pub fn add_prevFlagAttr(&mut self, prevFlagAttr: u32) {
	...
	pub fn add_newRoomMemberBinAttrInternal(&mut self, newRoomMemberBinAttrInternal: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u16>>) {
		self.fbb_
			.push_slot_always::<flatbuffers::WIPOffset<_>>(RoomMemberDataInternalUpdateInfo::VT_NEWROOMMEMBERBINATTRINTERNAL, newRoomMemberBinAttrInternal);
	}
	#[inline]
	pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> RoomMemberDataInternalUpdateInfoBuilder<'a, 'b> {
		let start = _fbb.start_table();
		RoomMemberDataInternalUpdateInfoBuilder { fbb_: _fbb, start_: start }
	}
	#[inline]
...
impl<'a: 'b, 'b> GetPingInfoResponseBuilder<'a, 'b> {
	...
	pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> GetPingInfoResponseBuilder<'a, 'b> {
		let start = _fbb.start_table();
		GetPingInfoResponseBuilder { fbb_: _fbb, start_: start }
	}
	#[inline]
...
impl<'a> SendRoomMessageRequest<'a> {
	...
	pub fn msg(&self) -> Option<&'a [u8]> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(SendRoomMessageRequest::VT_MSG, None)
			.map(|v| v.safe_slice())
	}
	#[inline]
...
impl<'a: 'b, 'b> SendRoomMessageRequestBuilder<'a, 'b> {
	...
	pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> SendRoomMessageRequestBuilder<'a, 'b> {
		let start = _fbb.start_table();
		SendRoomMessageRequestBuilder { fbb_: _fbb, start_: start }
	}
	#[inline]
...
impl<'a> RoomMessageInfo<'a> {
	...
	pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
		...
		if let Some(x) = args.srcMember {
			builder.add_srcMember(x);
		}
		if let Some(x) = args.dst {
			builder.add_dst(x);
		}
	...
	pub fn msg(&self) -> Option<&'a [u8]> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(RoomMessageInfo::VT_MSG, None)
			.map(|v| v.safe_slice())
	}
}
...
impl<'a: 'b, 'b> RoomMessageInfoBuilder<'a, 'b> {
	...
	pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> RoomMessageInfoBuilder<'a, 'b> {
		let start = _fbb.start_table();
		RoomMessageInfoBuilder { fbb_: _fbb, start_: start }
	}
	#[inline]
...
impl<'a> MessageDetails<'a> {
	...
	pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
		...
		if let Some(x) = args.communicationId {
			builder.add_communicationId(x);
		}
	...
	pub fn data(&self) -> Option<&'a [u8]> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(MessageDetails::VT_DATA, None)
			.map(|v| v.safe_slice())
	}
}
...
impl<'a: 'b, 'b> MessageDetailsBuilder<'a, 'b> {
	...
	pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> MessageDetailsBuilder<'a, 'b> {
		let start = _fbb.start_table();
		MessageDetailsBuilder { fbb_: _fbb, start_: start }
	}
	#[inline]
...
impl<'a> SendMessageRequest<'a> {
	...
	pub fn message(&self) -> Option<&'a [u8]> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(SendMessageRequest::VT_MESSAGE, None)
			.map(|v| v.safe_slice())
	}
	...
	pub fn npids(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
		self._tab
			.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(SendMessageRequest::VT_NPIDS, None)
	}
}
...
impl<'a> Default for SendMessageRequestArgs<'a> {
	#[inline]
	fn default() -> Self {
		SendMessageRequestArgs { message: None, npids: None }
	}
}
...
impl<'a: 'b, 'b> SendMessageRequestBuilder<'a, 'b> {
	...
	pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> SendMessageRequestBuilder<'a, 'b> {
		let start = _fbb.start_table();
		SendMessageRequestBuilder { fbb_: _fbb, start_: start }
	}
	#[inline]
